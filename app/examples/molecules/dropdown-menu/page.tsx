...
export default function DropdownMenuExamplesPage() {
  return (
    <div className="container py-10">
      <div className="mb-10">
        <h1 className="text-3xl font-bold mb-2">Dropdown Menu Examples</h1>
        <p className="text-lg text-muted-foreground">
          Interactive examples showcasing the versatility of the Dropdown Menu
          component.
        </p>
      </div>
      ...
      <div className="grid gap-10">
        ...
        <div className="border rounded-md p-6">
          ...
          <div className="mt-4 text-sm text-muted-foreground">
            Create visual hierarchy with inset menu items.
          </div>
        </div>
        ...
        <div className="border rounded-md p-6">
          ...
          <div className="mt-4 text-sm text-muted-foreground">
            Indicate unavailable options with disabled menu items.
          </div>
        </div>
      </div>
    </div>
